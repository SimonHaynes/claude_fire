...
> pensions are legally locked, so the ISAs fund everything: about £52,000 a
> year, drawn first from the cash reserve and then from the Vanguard tracker.
> That takes roughly £180,000 out of the ISAs over the bridge, leaving about
> £138,000 in them when Ada turns 57.
>
...
> by up to 40%, taking total spending from £52,000 to £43,000 until markets
...
- Give **numbers** — "about £180,000 over the bridge", not "a portion".
...
- Concrete over abstract: "£43,000 a year" beats "a reduced level of spending".
